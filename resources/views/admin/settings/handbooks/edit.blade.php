...
@section('content')
    {!! Form::open(['url' => route('admin.settings.handbooks.update', $handbook->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    {{ Form::bsSelect('global.blade.fields.coin', 'coin_id', $coins, true, $handbook->coin->id) }}
                </div>
            </div>
        </div>
    </div>
