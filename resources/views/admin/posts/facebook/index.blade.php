...
@section('title', trans('global.blade.title.list.facebook'))

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                {{ trans('global.blade.title.facebook') }}
            </h3>

            <div class="card-tools">
                <a class="btn btn-xs btn-success" href="{{ route('admin.facebook.create') }}">
            ...
            <table class="table table-striped projects">
                ...
                @foreach($posts as $post)
                    <tr data-entry-id="{{ $post->id }}">
                        ...
                        <td class="text-right">
                            <a class="btn btn-sm btn-info" href="{{ route('admin.facebook.edit', $post->id) }}">
                                <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.facebook.destroy', $post->id) }}"
                                  method="POST"
