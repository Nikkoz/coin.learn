...
@section('content')
    {!! Form::open(['url' => route('admin.twitter.update', $post->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="act">
                            <div class="row">
                                <div class="col-md-4">
                                    {{ Form::bsText('global.blade.fields.shares', 'shares', false, $post->shares) }}
                                </div>
