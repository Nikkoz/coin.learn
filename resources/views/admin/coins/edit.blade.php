    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::bsSwitch('coin.blade.create.form.status', 'status', $coin->status) }}

                    <div class="row">
                        <div class="col-md-4">
                            {{ Form::bsText('coin.blade.create.form.name', 'name', true, $coin->name) }}
                        </div>
                        ...
                        <div class="col-md-4">
                            {{ Form::bsSelectWithoutSearch('coin.blade.create.form.type', 'type', CoinTypeDictionary::getValues(), true, $coin->type) }}
                        </div>
                    </div>
